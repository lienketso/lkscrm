...
class Zalo
{
    ...
    public function syncTemplate()
    {
        ...
        foreach ($data as $item) {
            ...
            $modelTemplate->template_quality = ZaloTemplate::QUALITY_TITLE[$item->templateQuality];
            // $modelTemplate->template_tag = ZaloTemplate::TAG_TITLE[$tmpTemplateInfo->templateTag];
