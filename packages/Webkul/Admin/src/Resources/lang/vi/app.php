...
return [
    ...
    'layouts' => [
        ...
        'pipelines'            => 'Quy trình chăm sóc khách hàng',
        'pipelines-info'       => 'Thêm, chỉnh sửa hoặc xóa quy trình chăm sóc khách hàng từ CRM',
        'sources'              => 'Nguồn',
    ...
    'phase' => [
        ...
        'no-result-found'   => 'Không tìm thấy kết quả',
        'forbidden'         => 'Bạn không có quyền truy cập phase này',
        'index'             => [
            'title'      => 'Giai đoạn',
            'list'       => 'Danh sách Giai đoạn',
    ...
    'task' => [
        ...
        'no-result-found'   => 'Không tìm thấy kết quả',
        'forbidden'         => 'Bạn không có quyền truy cập task này',
        'index'             => [
            'title'      => 'Task',
            'list'       => 'Danh sách Task',
            'create-btn' => 'Tạo Task',
        ...
        'comment' => [
            'title' => 'Nhận xét',
            'create' => 'Thêm mới nhận xét',
            'edit' => 'Chỉnh sửa nhận xét',
            'delete' => 'Xoá nhận xét',
            'create-success'    => 'Thêm mới Nhận xét thành công.',
            'create-failed'     => 'Thêm mới nhận xét không thành công.',
            'update-success'    => 'Nhận xét đã được cập nhật thành công.',
            'update-failed'     => 'Nhận xét cập nhật không thành công.',
            'destroy-success'   => 'Nhận xét đã được xóa thành công.',
            'destroy-failed'    => 'Nhận xét không thể bị xóa.',
            'not-found'         => 'Không tìm thấy Nhận xét',
    ...
    'custom-setting'=>[
      ...
      'role'=>[
          'index-role-title'=>'Vai trò',
          'name'=>'Tên vai trò',
          'description'=>'Mô tả vai trò',
          'permission-type'=>'Loại vai trò',
          'custom'=>'Cấu hình riêng',
          'all'=>'Tất cả quyền',
          'create-role-btn'=>'Thêm vai trò',
          'save-btn'=>'Lưu vai trò',
          'general'=>'Thông tin vai trò',
          'permissions'=>'Phân quyền tính năng',
          'edit'=>'Sửa vai trò',
          'access-control'=>'Kiếm soát truy cập'
      ],
      'groups'=>[
          'index-group-title'=>'Nhóm quyền',
          'create-group-btn'=>'Thêm nhóm',
          'name'=>'Tên nhóm',
          'description'=>'Mô tả nhóm',
          'edit-group'=>'Sửa nhóm',
          'save-group-btn'=>'Lưu nhóm'
      ],
      'pipelines'=>[
          'pipeline-index-title'=>'Quy trình chăm sóc khách hàng',
          'create-pipeline'=>'Thêm quy trình',
          'name'=>'Tên quy trình',
          'rotten-days'=>'Số ngày chốt dự kiến',
          'type'=>'Loại khách',
          'is-default'=>'Quy trình mặc định',
          'save-btn'=>'Lưu quy trình',
          'mark-as-default'=>'Quy trình mặc định',
          'newly-added'=>'Mới thêm (chưa đặt tên)',
          'stage-name'=>'Tên giai đoạn',
          'probability'=>'Xác xuất thành công (%)',
          'delete-stage'=>'Xóa giai đoạn này',
          'new-stage'=>'Mới',
          'add-new-stages'=>"Thêm giai đoạn mới",
          'add-new-stage-for-your-pipeline'=>'Thêm giai đoạn vào quy trình chăm sóc của bạn',
          'stage-btn'=>'Thêm giai đoạn',
          'won-stage'=>'Đã chốt thành công',
          'lost-stage'=>'Không chốt được',
          'edit-pipeline'=>'Sửa quy trình',
      ]
    ],
