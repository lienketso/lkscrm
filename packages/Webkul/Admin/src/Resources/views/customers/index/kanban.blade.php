...
<v-customers-kanban>
    <div class="flex flex-col gap-4">
        <!-- Shimmer -->
        <x-admin::shimmer.customers.index.kanban />
    </div>
</v-customers-kanban>

{!! view_render_event('admin.customers.index.kanban.after') !!}

@pushOnce('scripts')
    <script type="text/x-template" id="v-customers-kanban-template">
                        ...
                        <div class="flex flex-col px-2 py-3">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @if (bouncer()->hasPermission('leads.create'))
                                    <a
                                        :href="'{{ route('admin.customers.create') }}' + '?stage_id=' + stage.id"
                                    ...
                                    <div class="flex flex-col items-center gap-4">
                                        <div class="flex flex-col items-center gap-2">
                                            <p class="text-xl font-semibold dark:text-white">
                                                @lang('admin::app.customers.index.kanban.empty-list')
                                            </p>

                                            <p class="text-gray-400 dark:text-gray-400">
                                                @lang('admin::app.customers.index.kanban.empty-list-description')
                                            </p>
                                        </div>
                                        ...
                                        @if (bouncer()->hasPermission('leads.create'))
                                            ...
                                            >
                                                @lang('admin::app.customers.index.kanban.create-lead-btn')
                                            </a>
                                        @endif
                                    </div>
                                </div>
                                        ...
                                        >
                                            ...
                                            <div class="absolute -top-1 right-7 hidden w-max flex-col items-center group-hover:flex">
                                                <span class="whitespace-no-wrap relative rounded-md bg-black px-4 py-2 text-xs leading-none text-white shadow-lg">
                                                    @{{ "@lang('admin::app.customers.index.kanban.rotten-days', ['days' => 'replaceDays'])".replace('replaceDays', element.rotten_days) }}
                                                </span>
    ...
    <script type="module">
        app.component('v-customers-kanban', {
            template: '#v-customers-kanban-template',
            ...
            methods: {
                ...
                updateStage: function (stage, event) {
                    ...
                    this.$axios
                        .put("{{ route('admin.customers.stage.update', 'replace') }}".replace('replace', event.added.element.id), {
