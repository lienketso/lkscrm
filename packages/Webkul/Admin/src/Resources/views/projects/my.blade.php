<x-admin::layouts>
    ...
    <!-- Header -->
    {!! view_render_event('admin.project.my.header.before') !!}

    <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
        {!! view_render_event('admin.project.my.header.left.before') !!}
        ...
        {!! view_render_event('admin.project.my.header.left.after') !!}

        {!! view_render_event('admin.project.my.header.right.before') !!}
        ...
        {!! view_render_event('admin.project.my.header.right.after') !!}
    </div>

    {!! view_render_event('admin.project.my.header.after') !!}

    {!! view_render_event('admin.project.my.content.before') !!}
    ...
    @pushOnce('scripts')
        ...
        >
            <x-admin::datagrid
                    :src="route('admin.my-projects.index')"
                    ref="datagrid"
            >
                <template #body="{
                    isLoading,
