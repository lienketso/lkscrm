<x-admin::layouts>
    ...
    <div class="flex flex-col gap-4">
        <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            ...
            <div class="flex items-center gap-x-2.5">
                {!! view_render_event('admin.my-tasks.index.create_button.before') !!}

                <!-- Create button for User -->
                @if (bouncer()->hasPermission('my_task.create'))
                    <div class="flex items-center gap-x-2.5">
                        <button
                                type="button"
                ...
                {!! view_render_event('admin.my-tasks.index.create_button.after') !!}
            </div>
        </div>
        <v-filter ref="filter">
    ...
    @pushOnce('scripts')
        ...
        <script
                ...
                id="tasks-template"
        >
            {!! view_render_event('admin.my-tasks.index.datagrid.before') !!}
                ...
                >
                    ...
                    <x-admin::modal size="large" ref="taskUpdateAndCreateModal">
                        ...
                        <x-slot:content>
                            ...
                            {!! view_render_event('admin.my-tasks.index.form.title.before') !!}
                            ...
                            {!! view_render_event('admin.my-tasks.index.form.title.after') !!}

                            {!! view_render_event('admin.my-tasks.index.form.description.before') !!}
                            <!-- Description -->
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                            ...
                            {!! view_render_event('admin.my-tasks.index.form.description.after') !!}

                            <div class="flex gap-4">
                                {!! view_render_event('admin.my-tasks.index.form.project.before') !!}
                                <x-admin::form.control-group class="flex-1">
                                    <x-admin::form.control-group.label class="required">
                                ...
                                {!! view_render_event('admin.my-tasks.index.form.project_id.after') !!}

                                {!! view_render_event('admin.my-tasks.index.form.phase_id.before') !!}
                                <x-admin::form.control-group class="flex-1">
                                    <x-admin::form.control-group.label class="required">
                                ...
                                {!! view_render_event('admin.my-tasks.index.form.phase_id.after') !!}
                            </div>

                            {!! view_render_event('admin.my-tasks.index.form.assignee_id.before') !!}
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                            ...
                            {!! view_render_event('admin.my-tasks.index.form.assignee_id.after') !!}

                            {!! view_render_event('admin.my-tasks.index.form.support_id.before') !!}
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                            ...
                            {!! view_render_event('admin.my-tasks.index.form.parent_id.before') !!}
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                            ...
                            {!! view_render_event('admin.my-tasks.index.form.parent_id.after') !!}

                            <div class="flex gap-4">
                                {!! view_render_event('admin.my-tasks.index.form.priority_id.before') !!}
                                <x-admin::form.control-group class="flex-1">
                                    <x-admin::form.control-group.label class="required">
                                        @lang('admin::app.task.index.datagrid.priority')
                                    </x-admin::form.control-group.label>
                                ...
                                {!! view_render_event('admin.my-tasks.index.form.priority_id.after') !!}

                                {!! view_render_event('admin.my-tasks.index.form.category_id.before') !!}
                                <x-admin::form.control-group class="flex-1">
                                    <x-admin::form.control-group.label class="required">
                                ...
                                {!! view_render_event('admin.my-tasks.index.form.category_id.after') !!}
                            </div>

                            <div class="flex gap-4">
                                {!! view_render_event('admin.my-tasks.index.form.start_date.before') !!}
                                <!-- start_date -->
                                <x-admin::form.control-group class="flex-1">
                                    <x-admin::form.control-group.label>
                                ...
                                {!! view_render_event('admin.my-tasks.index.form.start_date.after') !!}
                                ...
                                {!! view_render_event('admin.my-tasks.index.form.end_date.after') !!}
                            </div>

                            {!! view_render_event('admin.my-tasks.index.form.status_id.before') !!}
                            ...
                            {!! view_render_event('admin.my-tasks.index.form.status_id.after') !!}

                        </x-slot:content>

                        <!-- Modal Footer -->
                        <x-slot:footer>
                            {!! view_render_event('admin.my-tasks.index.modal.footer.save_button.before') !!}
                            ...
                            {!! view_render_event('admin.my-tasks.index.modal.footer.save_button.after') !!}
                        </x-slot:footer>
                    </x-admin::modal>
                ...
                >
                    ...
                    <x-admin::modal.comment size="large" ref="taskCommentModal">
                        ...
                        <x-slot:footer>
                            ...
                            />
                            {!! view_render_event('admin.my-tasks.index.form.content.before') !!}
                            <!-- Description -->
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label class="required">
                            ...
                            {!! view_render_event('admin.my-tasks.index.form.content.after') !!}
                            <!-- Save Button -->
                            <x-admin::button
                                    button-type="submit"
                                    class="primary-button justify-center"
        ...
        <script type="module">
          app.component('v-tasks', {
            ...
            methods: {
                ...
                fetchInputData () {
                // fetch assign input
                this.$axios.get(`{{ route('admin.my-tasks.getAssignOnlyMeInput') }}?project_id=${this.task.project_id}`).then(response => {
                ...
                this.$axios.get(`{{ route('admin.my-tasks.getParentTaskByProjectInput') }}?project_id=${this.task.project_id}&phase_id=${this.task.phase_id}`).then(response => {
              ...
              fetchUserSupport () {
                this.$axios.get(`{{ route('admin.my-tasks.getUserSupportInput') }}?project_id=${this.task.project_id}&assignee_id=${this.task.assignee_id}`).then(response => {
              ...
              createdOrUpdateComment (params, { resetForm, setErrors }) {
                ...
                this.$axios.post(params.id ? `{{ route('admin.my-tasks.updateComment', '') }}` : "{{ route('admin.my-tasks.storeComment') }}", commentForm).then(response => {
                  this.isProcessing = false

                  this.$emitter.emit('add-flash', { type: 'success', message: response.data.message ?? '' })
                  this.fetchTaskComment(`{{route('admin.my-tasks.getCommentByTaskId')}}?task_id=${this.taskComment.task_id}`)
              ...
              updateOrCreate (params, { resetForm, setErrors }) {
                ...
                this.$axios.post(params.id ? `{{ route('admin.my-tasks.update', '') }}/${params.id}` : "{{ route('admin.my-tasks.store') }}", tasksForm).then(response => {
                  this.isProcessing = false
              ...
              createSubTask (action) {
                this.$axios.get(action.url)
                  .then(response => {
                    ...
                    this.task.project_id = response.data?.data?.project_id
                    this.task.phase_id = response.data?.data?.phase_id
          ...
          app.component('v-filter', {
            ...
            data () {
              return {
                ...
                myTaskStatus:  @json($myTaskStatus ?? []),
