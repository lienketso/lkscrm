...
<div {{ $attributes->merge(['class' => 'box-shadow border-y border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900', 'style' => 'padding: 0px !important;']) }}>
    <v-accordion
        is-active="{{ $isActive }}"
        {{ $attributes }}
    >
        <x-admin::shimmer.accordion.custom class="h-[271px] w-[360px]" />
